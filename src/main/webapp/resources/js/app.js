document.addEventListener("DOMContentLoaded", function() {
  ...
  class FormSteps {
    ...
    updateForm() {
      ...
      document.getElementById("summaryCity").textContent = "miasto: " + document.getElementById("city").value;
      document.getElementById("summaryStreet").textContent = "ulica: " + document.getElementById("street").value;
      document.getElementById("summaryZipCode").textContent = "kod pocztowy: " + document.getElementById("zipCode").value;
      document.getElementById("summaryPhone").textContent = "telefon: " + document.getElementById("phone").value;
      document.getElementById("summaryDate").textContent = "data: " + document.getElementById("pickUpDate").value;
      document.getElementById("summaryTime").textContent = "godzina: " + document.getElementById("pickUpTime").value;
      document.getElementById("summaryComment").textContent = "uwagi dla kuriera: " + document.getElementById("pickUpComment").value;
